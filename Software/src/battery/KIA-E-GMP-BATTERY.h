...
class KiaEGmpBattery : public UdsCanBattery {
 ...
 private:
  ...
  // --- EXPERIMENTAL: candidate coolant pump / valve "actuator" broadcasts ---
  // These IDs are NOT sent by the vehicle side in the real car - they are broadcast
  // directly onto the P-CAN bus by separate physical modules (candidates for the
  // battery's electronic coolant pump, the DATC coolant pump, and coolant valve A).
  // Payloads below are static snapshots captured from a real EV6, used only to test
  // whether their mere presence on the bus stops U111800/U111900/U112800 from setting.
  // Bytes are NOT recalculated (checksum/counter unknown) - remove entries here once
  // you've identified which ones actually matter.
  static constexpr CAN_frame candidate_actuator_messages[] = {
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x035, .data = {0x47, 0xe0, 0xfd, 0x01, 0x00, 0x00, 0x21, 0x05,
                                                                     0x31, 0x00, 0x00, 0x10, 0x00, 0x40, 0x00, 0x00,
                                                                     0x02, 0x01, 0x00, 0x00, 0x80, 0x3a, 0x81, 0xd4,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x0B0, .data = {0xa7, 0xf6, 0x19, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x0F5, .data = {0xe1, 0xbd, 0xfd, 0x46, 0x4e, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x15, 0x00, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                                     0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x145, .data = {0x79, 0x2f, 0xf5, 0x08, 0x04, 0x04, 0x00, 0x00,
                                                                     0x01, 0x04, 0x7d, 0x00, 0x40, 0xda, 0x05, 0x00,
                                                                     0x00, 0x00, 0x53, 0x00, 0x30, 0x5f, 0x40, 0x06,
                                                                     0x00, 0x53, 0x00, 0xc8, 0x00, 0x00, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x16A, .data = {0x88, 0x4d, 0x55, 0x01, 0x01, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
                                                                     0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x1A0, .data = {0xce, 0x35, 0xfc, 0xfe, 0xf7, 0x7f, 0x64, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00,
                                                                     0xff, 0xf3, 0x3f, 0x14, 0x0a, 0x00, 0x00, 0x00,
                                                                     0xfe, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x1B0, .data = {0x86, 0x3e, 0xf5, 0x00, 0x72, 0x00, 0x00, 0x10,
                                                                     0x23, 0x00, 0x04, 0x1b, 0xa9, 0x00, 0x30, 0xde,
                                                                     0xa9, 0x86, 0x00, 0x00, 0x6b, 0x6d, 0xaa, 0xa8,
                                                                     0xb7, 0xbd, 0x14, 0x00, 0x00, 0x42, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x090, .data = {0x79, 0x82, 0x31, 0x1d, 0x00, 0x00, 0x00, 0x00,
                                                                     0x3b, 0x80, 0x02, 0x00, 0x30, 0x06, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x1FA, .data = {0x36, 0x09, 0x33, 0x00, 0x64, 0x64, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x32, 0x00,
                                                                     0x00, 0x1a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x255, .data = {0x04, 0xff, 0x30, 0x15, 0x00, 0x00, 0xf0, 0x01,
                                                                     0x00, 0x96, 0x00, 0x33, 0x70, 0x07, 0x00, 0x96,
                                                                     0x00, 0x1b, 0x1b, 0x00, 0x30, 0x15, 0x00, 0x1c,
                                                                     0xf2, 0x05, 0x96, 0x18, 0x40, 0x02, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x27A, .data = {0x4d, 0xd4, 0x32, 0x1d, 0x00, 0x00, 0x00, 0xfe,
                                                                     0x00, 0x00, 0x00, 0x00, 0xb8, 0x02, 0x2c, 0x01,
                                                                     0x99, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
      {.FD = true, .ext_ID = false, .DLC = 32, .ID = 0x2AA, .data = {0x6f, 0x1b, 0x33, 0xff, 0xff, 0x00, 0x00, 0x00,
                                                                     0x00, 0xff, 0xff, 0x00, 0x00, 0x40, 0x90, 0x00,
                                                                     0x00, 0x02, 0x00, 0x00, 0xff, 0xff, 0xff, 0x0f,
