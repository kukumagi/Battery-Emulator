#ifndef KIA_HYUNDAI_E_GMP_BATTERY_H
#define KIA_HYUNDAI_E_GMP_BATTERY_H
#include <Arduino.h>
...
extern uint32_t system_max_discharge_power_W;              //W,    0-65000
extern uint32_t system_max_charge_power_W;                 //W,    0-65000
